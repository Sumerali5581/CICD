...
<body>
  <%
    ...
    Connection con1=DriverManager.getConnection("jdbc:mysql://database-1.cbk04ukggkcd.ap-south-1.rds.amazonaws.com:3306/student_manage", "root", "root1234t");
    
    String s="select username, f_name, l_name, email from students";
    ...
    <main class="table">
      ...
      <section class="table_body">
        <table>
          <thead>
            <tr>
              <th style="padding-left: 110px;">Username</th>
              <th style="padding-left: 110px;">Full Name</th>
          ...
          <tbody>
            <%while(rs1.next()) {%>
              <tr>
                ...
                <td style="padding-left: 100px;"><%=rs1.getString(2)%> <%=rs1.getString(3)%></td>
                <td style="padding-left: 100px;"><%=rs1.getString(4)%></td>
                <!--changes-->
                <td>
                  <form method="post" action="remove_stud">
                    <input type="hidden" name="stud" value="<%=rs1.getString(1)%>">
                    <button class="btn" type="submit"
                      onclick="return confirm('Are you sure you want remove<%=rs1.getString(1)%>?')">Remove</button>
                  </form>
                </td>
                <!--upto here-->
              </tr>
