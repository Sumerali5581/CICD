...
<head>
    ...
    <title>Faculty and Courses</title>
...
<body>
    <main class="table">
        ...
        <%
            ...
            Connection con11=DriverManager.getConnection("jdbc:mysql://database-1.cbk04ukggkcd.ap-south-1.rds.amazonaws.com:3306/student_manage", "root", "root1234");
      ...
      <section class="table_header">
        <h1 align="center">Faculty and Courses</h1>
      </section>
