...
<%
    int n_c=0;
    int dl=0;
    String msg="Welcome to course";
    
    try
    {
        dl=(int) request.getAttribute("dl");
...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Ubuntu:wght@500&family=Kalam:wght@700&family=Kanit&display=swap"
        rel="stylesheet">
    ...
    <style>
        * {
        ...
        .clinks:hover{
            background-color: rgb(68, 183, 250);
        }
...
<body>
    ...
    <nav>
        <ul>
            <li>
                <a href="#" class="logo">
                    <img src="https://i.ibb.co/YbT5CNv/logo1.png" alt="logo" width="500px">
            ...
            <li>
                <a href="goto_yourcrs">
                    ...
                    <span class="nav-item">Your Courses</span>
                </a>
            </li>
            <li>
                <a href="goto_enroll">
                    ...
                    <span class="nav-item">Enroll New Course</span>
                </a>
            </li>
            <li>
                <a href="dark_or_light">
                    <span class="material-symbols-outlined">
                        settings
                    </span>
                    <span class="nav-item">Dark / Light</span>
                </a>
            </li>
            <li>
                <a href="#">
...
<script>
    ...
    document.querySelector(" #close").addEventListener("click",
        function () {
          ...
          var messagesIcon = document.querySelector('.messages-icon');
          var messagesList = messagesIcon.querySelector('.messages-list');
          
          messagesIcon.addEventListener('click', function() {
            messagesList.classList.toggle('show');
          });
          
          var messages = messagesList.querySelectorAll('li');
          
          messages.forEach(function(message) {
            var readButton = message.querySelector('.read-button');
          ...
          document.addEventListener('click', function(e) {
            if (!messagesIcon.contains(e.target)) {
              messagesList.classList.remove('show');
            }
          });
</script>
